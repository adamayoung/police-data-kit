...
final class UKStopAndSearchRepositoryTests: XCTestCase {
    ...
    var service: UKStopAndSearchRepository!
    ...
    override func setUp() {
        ...
        service = UKStopAndSearchRepository(apiClient: apiClient, cache: cache, availableDataRegion: availableDataRegion)
    }
    ...
    func testStopAndSearchesAtCoordinateReturnsStopAndSearches() async throws {
        ...
        let date = Date()
        let expectedResult = StopAndSearchDataModel.mocks
    ...
    func testStopAndSearchesAtLocationWhenNotCachedAndReturnsStopAndSearchesShouldCacheResult() async throws {
        ...
        let cachedResult = await cache.object(for: cacheKey, type: [StopAndSearchDataModel].self)
