...
final class NeighbourhoodLocationDataModelTests: XCTestCase {
    ...
    func testInitWhenLatitudeIsNilSetsCoordinateAsNil() {
        let result = NeighbourhoodLocationDataModel(type: "test", address: "123 Kafe Street", postcode: "AB12 3CD", longitude: 1)

        XCTAssertNil(result.coordinate)
    }

    func testInitWhenLongitudeIsNilSetsCoordinateAsNil() {
        let result = NeighbourhoodLocationDataModel(type: "test", address: "123 Kafe Street", postcode: "AB12 3CD", latitude: 1)
    ...
    func testCoordinateWhenInvalidLatitudeAndLongitudeReturnsZeros() throws {
        ...
        let result = try JSONDecoder.policeDataAPI
            .decode(NeighbourhoodLocationDataModel.self, fromResource: "neighbourhood-location-invalid-coordinates").coordinate
    ...
    func testCoordinateWhenLatitudeAndLongitudeIsNilReturnsNil() throws {
        let result = try JSONDecoder.policeDataAPI
            .decode(NeighbourhoodLocationDataModel.self, fromResource: "neighbourhood-location-null-coordinates").coordinate
