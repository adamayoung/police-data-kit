...
public final class UKStopAndSearchRepository: StopAndSearchRepository {
    ...
    public func stopAndSearches(atCoordinate coordinate: Coordinate, date: Date) async throws -> [StopAndSearch]? {
    ...
    public func stopAndSearches(inArea boundary: Boundary, date: Date) async throws -> [StopAndSearch] {
