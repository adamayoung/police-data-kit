...
public final class UKCrimeRepository: CrimeRepository {
    ...
    public func streetLevelCrimes(atCoordinate coordinate: Coordinate, date: Date) async throws -> [Crime]? {
    ...
    public func streetLevelCrimes(inArea boundary: Boundary, date: Date) async throws -> [Crime]? {
    ...
    public func crimes(atCoordinate coordinate: Coordinate, date: Date) async throws -> [Crime]? {
    ...
    public func crimesWithNoLocation(forCategory categoryID: CrimeCategory.ID,
